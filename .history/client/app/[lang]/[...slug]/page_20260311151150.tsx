...
export default async function page({params, searchParams}: pageProps) {
    ...
    const allLots = await getLot

  return (
    <div className='flex justify-start items-start w-full h-screen relative gap-2'>
        <Filter />
        <Catalog category={category} subCategory={subCategory} subSubCategory={subSubCategory} city={city}/>
    </div>
  )
}
