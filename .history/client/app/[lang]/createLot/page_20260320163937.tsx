...
function page() {
  ...
  return (
  <div className="flex flex-col justify-center items-center w-full gap-10 bg-gray-100">
    {loading ? (
      ...
      {confirmCreateOrder && (
        ...
        <div className="flex justify-between items-center w-[90%] mt-10">
          ...
          <span o className={`${hover} flex justify-center items-center`}><ChevronDown className="rotate-90"/> Назад</span>
        </div>
          <div className="flex flex-col justify-center items-start md:w-2/3  rounded-xl gap-4">
