...
function page() {
  ...
  return (
  <div className="flex flex-col justify-center items-center w-full  bg-white md:bg-gray-100 text-black">
    {loading ? (
      ...
      {confirmCreateOrder && (
        ...
        <div className="flex justify-between items-center w-[90%] mt-10">
          ...
          <div className="flex flex-col justify-center items-start w-full md:w-2/3 rounded-xl gap-4">
