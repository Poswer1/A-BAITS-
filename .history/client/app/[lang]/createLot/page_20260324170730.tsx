...
function page() {
  ...
  <div className="flex flex-col justify-center items-center w-full gap-10 bg-white md:bg-gray-100 text-black">
    ...
    {openCategory && (
      <CategoryList setOpenCategory={setOpenCategory} openFrom="createLot" createLotCategory={category} createLotSetCategory={setCategory} subCategory={subCategory} setSubCategory={setSubCategory} subSubCategory={subSubCategory} setSubSubCategory={setSubSubCategory}/>
    )}
  </div>
  )
}
