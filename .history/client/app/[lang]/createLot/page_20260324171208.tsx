...
function page() {
  ...
  <div className="flex flex-col justify-center items-center w-full gap-10 bg-white md:bg-gray-100 text-black">
    ...
    {openCategory && (
      ...
      createLotSetCategory={setCategory} createLotSubCategory={subCategory} createLotSetSubCategory={setSubCategory} createLotSubSubCategory={subSubCategory} createLotSetSubSubCategory={setSubSubCategory}/>
    )}
  </div>
  )
}
