...
function page() {
    ...
    const [loading, setLoading] = useState(true)
      ...
      const transleteSubCategory = getValueByLang(categoriesWithIcons, subCategory, lang)
      const transleteSubSubCategory = getValueByLang(categoriesWithIcons, subSubCategory, lang)
  ...
  <div className="flex flex-col justify-center items-center w-full gap-10 bg-white md:bg-gray-100 text-black">
       ...
       <Success title={'Спасибо! Лот успешно создан и опубликован'}/>
        ...
        <div className="flex justify-between items-center w-[90%] mt-10">
          ...
          <div className="flex flex-col justify-center items-start w-full md:w-2/3 rounded-xl md:gap-4">
            ...
            <MainInfoSections openCategory={openCategory} setOpenCategory={setOpenCategory} name={name} setName={setName} createLotCategory={category}  createLotSubCategory={subCategory}  createLotSubSubCategory={subSubCategory} />
    ...
    {openCategory && (
      ...
      openFrom="createLot" 
      createLotCategory={category} 
      createLotSetCategory={setCategory} 
      createLotSubCategory={subCategory} 
      createLotSetSubCategory={setSubCategory} 
      createLotSubSubCategory={subSubCategory} 
