      ...
      {!lot ? (
        ...
        <div className="flex  justify-start items-start w-[80%] py-2 gap-2 h-200">
            ...
            <div className="flex flex-col justify-start items-start">
              <InfoSection lot={lot} socket={socket} currentPrice={currentPrice} setCurrentPrice={setCurrentPrice} value={value} setValue={setValue} status={status} setStatys={setStatus}/>
