...
function page() {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full relative mt-5 min-h-150 h-auto">
      {!lot ? (
        <Loading />
      ): (
        <>
          <HeaderLot lot={lot}/>
          <div className="flex flex-col md:flex-row justify-start items-start 2xl:w-[80%] lg:w-[90%] py-2 gap-2 h-200">
