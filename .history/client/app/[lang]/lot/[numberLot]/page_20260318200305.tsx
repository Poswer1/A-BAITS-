  ...
  return (
    <div className="flex flex-col justify-center items-center w-full relative  min-h-150">
      {!lot ? (
        ...
        <>
          <HeaderLot lot={lot} transleteCity={transleteCity} transleteState={transleteState} TransleteCategory={TransleteCategory} TransleteSubCategory={TransleteSubCategory}/>
