  ...
  return (
    <div className="flex flex-col justify-center items-center w-full relative min-h-150">
      {!lot ? (
        ...
        <>
          <div className="hidden md:block w-full sticky top-0 z-20">
            <HeaderLot lot={lot}/>
          </div>
          <div className="flex flex-col md:flex-row justify-start items-start 2xl:w-[80%] lg:w-[90%] py-2 md:gap-2 min md:h-200">
