...
function page() {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full relative min-h-150 h-auto">
      {loading ? (
        <div className="flex overflow-hidden flex-col md:flex-row justify-start items-start 2xl:w-[80%] lg:w-[90%] py-2 md:gap-2 min-h-200 md:h-200">
          <div className="flex flex-col w-full md:w-1/2 gap-2">
            <div className="h-90 md:h-130 skeleton w-full"></div>
            <div className="flex overflow-x-auto flex-row md:flex-wrap w-full gap-5">
