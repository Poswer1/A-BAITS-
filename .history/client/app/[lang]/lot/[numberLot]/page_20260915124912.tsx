...
function page() {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full relative min-h-150 h-screen">
      {loading ? (
        ...
        <>
          ...
          <div className="flex flex-col md:flex-row justify-start items-start 2xl:w-[80%] lg:w-[90%] py-2 md:gap-2 min-h-200 md:h-200">
              ...
              <div className="flex flex-col justify-start items-start w-full md:w-auto">
                ...
                <InfoSection lot={lot} socket={socket} currentPrice={currentPrice} setCurrentPrice={setCurrentPrice} value={value} setValue={setValue} status={status} setStatus={setStatus} auth={auth} buyConfirm={buyNowConfirm} setBuyConfirm={setBuyNowConfirm}/>
