  ...
  return (
    ...
    <div className="flex flex-col justify-start items-center gap-10">
        ...
        <div className="absolute inset-0 h-full bg-gradient-to-l from-orange-600/12 via-orange-600/12 to-transparent z-0"></div>
          ...
          <div className="flex flex-col justify-center items-start gap-4 w-full  md:w-3/6 lg:ml-20 2x:ml-40">
            ...
            <div className="flex justify-center items-center gap-10">
              {Features.map((item) => {
                ...
                <div className="flex flex-col justify-center items-center text-center gap-2">
                  <div className="2xl:p-4 lg:p-3 rounded-full border border-orange-600"><Icon size={25}/></div>
                  <span className="text-black 2xl:text-base lg:text-sm">{item.text}</span>
                </div>
                )
              })}
            </div>
          ...
          <div className="lg:w-3/4 2xl:w-2/4 bg-white/35 h-90 clip-45 flex justify-end  items-center">
            ...
            <Image src='/images/main/fishman.png' alt="" width={300} height={300} className="2xl:w-[300px] lg:w-[250px] h-auto"/>
          </div>
        ...
        <div className="flex flex-col justify-center items-start w-[90%]">
           ...
           <div className="flex justify-center items-center w-full px-10 py-5 2xl:gap-15 lg:gap-10">
