  ...
  return (
    ...
    <div className="flex flex-col justify-start items-center gap-10">
        ...
        <div className="absolute inset-0 h-full bg-gradient-to-l from-orange-600/12 via-orange-600/12 to-transparent z-0"></div>
          ...
          <div className="flex flex-col justify-center items-start gap-4 w-[90%] text-center md:text-start md:w-3/6 lg:ml-20 2x:ml-40 h-90">
          ...
          <div className="lg:w-3/4 2xl:w-2/4 bg-white/35 h-90 clip-45 flex justify-end  items-center hidden">
