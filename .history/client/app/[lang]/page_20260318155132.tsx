  ...
  return (
    ...
    <div className="flex flex-col justify-start items-center gap-10">
        ...
        <div className="flex flex-col justify-center items-start w-[90%]">
           ...
           <div className="flex justify-center items-start w-full overflow-x-auto md:overflow-x-visible gap-5 px-10 py-5 2xl:gap-15 lg:gap-10">
            {allLot.slice(0, 4).map((lot) => (
              <LotCard lot={lot}/>
            ))}
            <div className="flex justify-between items-center w-full absolute">
              <div className={`${hover} flex justify-start items-center bg-orange-600 py-4 rounded-r-full`}>
                 <ChevronDown className="text-white rotate-90" size={35}/>
              </div>
              <div className={`${hover} flex justify-start items-center bg-orange-600 py-4 rounded-l-full`}>
                 <ChevronDown className="text-white rotate-270" size={35}/>
              </div>
            </div>
           </div>
        </div>
