...
export default function Home() {
  ...
  return (
    ...
    <div className="flex flex-col justify-start items-center gap-10">
        ...
        <div className="flex flex-col justify-center items-start md:items-start w-full bg-orange-300 md:w-[90%]">
           <h1 className="text-3xl font-bold text-black"><span className="text-orange-600">Топ </span>{t('global','lot')}</h1>
           <div className="flex justify-start items-start bg-orange-600 w-full overflow-x-auto md:overflow-x-visible gap-5 px-10 py-5 2xl:gap-15 lg:gap-10">
