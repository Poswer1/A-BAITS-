        ...
        <div className="flex flex-col justify-center items-start gap-2 bg-white p-4 rounded-md w-full">
          ...
          <div className='flex justify-center items-center gap-1'>
            ...
            <div className='flex flex-col justify-center items-start'>
             <span className='text-sm text-gray-500'>{review.lot.name}</span>
             <span className='text-sm text-orange-600'>№ <span className='text-orange-600'>{review.lot.lotNumber}</span></span>
            </div>
          </div>
