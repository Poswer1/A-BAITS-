              ...
              <h1 className="text-xl">{t('profile', 'settingsProfile')}</h1>
                <div className="flex flex-col justify-start items-start w-4/5 gap-5">
                  ...
                  <div className="flex w-1/2">
                    <SelectionField title={t('profile', 'selectCity')} placeholder={t('profile', 'selectCity')} setValue={setLocationLang} setValueLang={setLocationLang} valueLang={locationLang} list={LocationList}/>
                  </div>
