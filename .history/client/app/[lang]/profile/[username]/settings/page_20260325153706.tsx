                  ...
                  <div className={blockClass}>
                        ...
                        <div className="flex flex-col justify-center items-start">
                          ...
                          <div className="flex flex-col md:flex-row justify-center text-center items-start gap-2 mt-1">
                            <label htmlFor="selectPhoto" className={`${button} !p-2 text-sm md:text-base w-full`}>{t('profile', 'changeAvatar')}</label>
                            <input type="file" id="selectPhoto" onChange={handleFile} className="hidden"/>
                            <button className={`${buttonWithoutBg} !p-2 text-sm md:text-base w-full`} onClick={handleDefaultAvatar}>{t('profile', 'defultAvatar')}</button>
                          </div>
                        </div>
                  </div>
                  {(message || error) && (
