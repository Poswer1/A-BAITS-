  ...
  return (
    <div className={pageContainerClass}>
      ...
      <div className='flex justify-center items-start gap-2'>
        ...
        <div className={`${blockClass} flex-col min-h-150 lg:w-full 2xl:!w-250 !gap-0`}>
          {selectChat.length === 0 ? (
            <h1>чат не выбран</h1>
          ): (
            <>
            <div className='flex justify-between items-center w-full border-b border-b-gray-200 pb-2 w-15'>
