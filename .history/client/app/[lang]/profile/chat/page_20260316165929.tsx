  ...
  return (
    <div className={pageContainerClass}>
      ...
      <div className='flex justify-center items-start gap-2'>
        ...
        <ChatList setSelectChat={setSelectChat} setTypeChat={setTypeChat} set/>

        <div className={`${blockClass} flex-col min-h-150 ${selectChat.length === 0 ? 'lg:hidden': ''} 2xl:!w-250 2xl:block !gap-0`}>
          {selectChat.length === 0 ? (
            <h1>чат не выбран</h1>
          ): (
            <>
