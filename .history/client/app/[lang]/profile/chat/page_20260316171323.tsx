...
function page() {
  ...
  return (
    <div className={pageContainerClass}>
      ...
      <h1 className={`flex justify-center 2xl:hidden lg:hidden 2xl:text-2xl lg:text-xl mb-5 ${selectChat && 'lg:!block w-full'}`}><ChevronDown className='rotate-90' />Назад</h1>
