  ...
  return (
    <div className={`${pageContainerClass} h-150`}>
      ...
      <div className='flex justify-start items-start gap-2 w-full'>
        ...
        <div className={`${blockClass} flex-col min-h-150 ${selectChat.length === 0 ? 'lg:hidden': ''} xl:w-2/3 2xl:!w-3/5 2xl:block !gap-0`}>
          {selectChat.length === 0 ? (
            <h1>чат не выбран</h1>
          ): (
            <>
            ...
            <div className='flex flex-col justify-start items-start overflow-auto lg:h-100 lg:h-max-100 2xl:h-130 2xl:max-h-130 w-full mt-2 noScrollbar gap-2'>
              {typeChat === 'deal' && (
