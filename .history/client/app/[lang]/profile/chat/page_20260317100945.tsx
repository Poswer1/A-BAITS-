  ...
  return (
    <div className={`${pageContainerClass} h-150`}>
      ...
      <div className='flex justify-start items-start gap-2 w-full'>
        ...
        <div ref={chatRef} className={`${blockClass} flex-col min-h-150 xl:w-2/3 2xl:!w-3/5 !gap-0`}>
          {selectChat.length === 0 ? (
            <h1>чат не выбран</h1>
          ): (
            <>
            ...
            <div className='flex flex-col justify-start items-start overflow-auto lg:h-110 lg:h-max-110 2xl:h-130 2xl:max-h-130 w-full mt-2 noScrollbar gap-2'>
              {typeChat === 'deal' && (
