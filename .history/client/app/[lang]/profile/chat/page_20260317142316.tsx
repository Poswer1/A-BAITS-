      ...
      <div className='flex justify-start items-start gap-2 w-full'>
        ...
        <div className={`${blockClass} ${!selectChat ? 'hidden md:block': 'fixed top-0 left-0 md:static'} flex-col min-h-150 xl:w-2/3 2xl:!w-3/5 !gap-0`}>
          {!selectChat ? (
            ...
            <div ref={chatRef} className='flex flex-col justify-start items-start overflow-auto max-h-50 md:h-110 md:h-max-110 2xl:h-130 2xl:max-h-130 w-full mt-2 noScrollbar gap-2'>
              {chat?.type === 'deal' && (
