  ...
  return (
    <div className={`${pageContainerClass} h-150`}>
      ...
      <div className='flex justify-start items-start gap-2 w-full'>
        ...
        <div className={`${blockClass} ${!selectChat ? 'hidden md:block': 'fixed top-0 left-0 md:static'} h-screen md:h-auto flex-col min-h-150 xl:w-2/3 2xl:!w-3/5 !gap-0 relative`}>
          {!selectChat ? (
            <h1>чат не выбран</h1>
          ): (
            <>
            ...
            {chat?.status !== 'Close' ? (
              <div className='flex justify-center items-center w-full gap-2 fixed top-full'>
