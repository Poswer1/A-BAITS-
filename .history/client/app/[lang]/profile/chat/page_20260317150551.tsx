  ...
  return (
    <div className={`${pageContainerClass}`}>
      ...
      <div className='flex justify-start items-start gap-2 w-full'>
        ...
        <div className={`${blockClass} ${!selectChat ? 'hidden md:block': 'fixed top-0 left-0 md:static'}  h-screen md:h-110 md:h-max-110 2xl:h-190 2xl:max-h-160 flex-col xl:w-2/3 2xl:!w-3/5 !gap-0 `}>
          {!selectChat ? (
            <h1>чат не выбран</h1>
          ): (
            <>
