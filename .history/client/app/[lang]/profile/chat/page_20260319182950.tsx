            ...
            <div ref={chatRef} className='flex flex-col justify-start items-start overflow-auto max-h-full h-full w-full mt-2 noScrollbar gap-2'>
              {chat?.type === 'deal' && (
                <div className={`w-full flex flex-col justify-center items-center text-center`}>
                   ...
                   <div className='flex flex-col md:flex-row w-full md:w-auto justify-center items-center gap-2 mt-1'>
                    <Link href={`/${lang}/review/${selectChat}`} className={`${button} !p-2 w-full`}>{t('chat', 'ExchangeReview')}</Link>
                    <button className={`${buttonWithoutBg} !p-2 w-full`}>{t('chat', 'InviteModer')}</button>
                  </div>
                </div>
              )}
                    ...
                    return (
                      msg.to !== user?._id && (
                        <div className='flex justify-center items-center w-full'>
                          <div className={`flex flex-col justify-center items-center w-full md:w-1/2 py-1 bg-orange-600/10 rounded-md`}>
