...
function layout({children}: {children: React.ReactNode}) {
  ...
  return (
    <div className='flex flex-col md:flex-row justify-start items-start md:min-h-250 xl:min-h-300 overflow-hidden text-black w-full bg-gray-100 overflow-x-hidden'>
      {loading ? (
