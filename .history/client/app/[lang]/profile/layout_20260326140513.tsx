...
function layout({children}: {children: React.ReactNode}) {
  ...
  return (
    <div className='flex flex-col md:flex-row justify-start min-h-screen items-start overflow-hidden overflow-y-auto text-black w-full bg-gray-100 overflow-x-hidden'>
      {loading ? (
