...
function layout({children}: {children: React.ReactNode}) {
  ...
  return (
    <div className='flex flex-col md:flex-row justify-start h-screen items-start overflow-hidden text-black w-full bg-gray-100 overflow-x-hidden'>
      {loading ? (
        ...
        <>
          <div className={`${(!name || name === username) ? '' : 'hidden md:invisible md:flex flex flex-col justify-start items-start w-full max-h-screen md:p-5 overflow-y-auto'}`}>
