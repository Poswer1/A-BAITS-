...
export default function page() {
  ...
  return (
    <div className='w-full flex flex-col justify-center items-center bg-gray-100 h-100 md:h-150 xl:h-200 text-black'>
        <div className='flex flex-col justify-center items-center w-full md:w-2/5 xl:w-1/4'>
            
            <div className='flex flex-col justify-center items-center gap-2 bg-white rounded-xl p-2'>
                <div className='flex justify-start items-center gap-2 w-full'>
                    <AvatarBlock avatar={lot?.images?.[0]} size={50}/>
                    <span>Могучее зерно</span>
                </div>
                <div className='flex justify-center items-center w-full gap-2  rounded-lg'>
                    <img src={`${BASE_URL}${lot?.images?.[0]}`} className='w-20 rounded-l-lg'/>
