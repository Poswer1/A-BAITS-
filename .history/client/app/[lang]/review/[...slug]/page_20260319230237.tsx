  ...
  return (
    <div className='w-full flex flex-col justify-center items-center bg-gray-100 h-auto md:h-150 xl:h-200 text-black'>
        {loading ? (
            ...
            <div className='bg-white md:rounded-xl p-3 flex flex-col justify-center items-center w-full md:w-2/5 xl:w-1/4 gap-2'>
            <div className='flex w-full flex-col justify-center items-center gap-2 bg-white rounded-xl'>
                <div className='flex justify-start items-center gap-2 w-full'>
                    <AvatarBlock avatar={user?.avatar} size={50}/>
                    <span>{user?.name}</span>
                </div>
                <div className='flex justify-start items-center w-full gap-2'>
                    <img src={`${BASE_URL}${lot?.images?.[0]}`} className='w-15'/>
