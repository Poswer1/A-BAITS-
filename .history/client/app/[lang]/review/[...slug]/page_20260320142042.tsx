...
export default function page() {
  ...
  return (
    <div className='w-full flex flex-col justify-center items-start bg-gray-100 h-auto md:h-150 xl:h-200 text-black'>
        <div className='flex justify-start items-start w-[90%]'>
            <h1 className='text-3xl font-bold text-black'><span className='text-orange-600'>Ваш</span> отзыв</h1>
        </div>
