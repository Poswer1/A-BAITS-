...
export default function page() {
  ...
  return (
    <div className='w-full flex flex-col justify-start items-center bg-gray-100 h-auto md:h-150 xl:h-200 text-black gap-10'>
        <div className='flex justify-between items-center w-[70%] mt-10'>
            <h1 className='text-3xl font-bold text-black text-start'><span className='text-orange-600'>Ваш</span> отзыв</h1>
            <span className={`text-black flex justify-center items-center gap-1 ${hover}`}><ChevronLeft /> Назад</span>
        </div>
            <div className='bg-white md:rounded-xl p-3 md:p-5 flex flex-col justify-center items-center w-full md:w-2/5 xl:w-1/4 gap-2'>
                 <h1 className='text-3xl font-bold text-black text-start'><span className='text-orange-600'>Ваш</span>{t("")}</h1>
