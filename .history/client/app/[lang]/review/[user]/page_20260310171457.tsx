...
export default function page() {
    ...
    const handleReview = async () => {
        ...
        try {
            await newReview(token, name, comment)
        } catch (error) {
  ...
  return (
    <div className='w-full flex justify-center items-center bg-gray-100 h-screen'>
        <div className='bg-white p-5 flex flex-col justify-center items-center w-1/4'>
            ...
            <InputField label='' value={comment} type='text' placeholder={t('review', 'shortComment')} onChange={setComent} textarea={true} hTextArea={50}/>
            {message && (
