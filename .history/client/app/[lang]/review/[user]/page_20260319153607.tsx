...
export default function page() {
  ...
  return (
    <div className='w-full flex justify-center items-center bg-gray-100 md:h-150 xl:h-200 text-black'>
        <div className='bg-white p-5 flex flex-col justify-center items-center w-full md:w-2/4 xl:w-1/4 gap-2'>
