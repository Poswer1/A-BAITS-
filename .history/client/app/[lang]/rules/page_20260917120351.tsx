...
function RulesPage() {
  ...
  return (
    <main className='flex justify-center w-full min-h-screen bg-gray-50 px-4 py-8 md:px-8 md:py-12'>
      <article className="w-full max-w-4xl rounded-2xl bg-white px-5 py-7 shadow-sm md:px-10 md:py-10">
        <h1 className="text-3xl font-bold text-orange-600 md:text-4xl">{t('rules', 'rulesTitle')}</h1>
