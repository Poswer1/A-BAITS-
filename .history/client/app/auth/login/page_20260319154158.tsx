...
function page() {
  ...
  return (
    <div className='flex flex-col justify-center items-center h-screen w-full text-black'>
        <div className='flex flex-col justify-center items-center md:w-[1/2] xl:w-[20%] rounded-md p-5 gap-5'>
            {message && (
                <div style={{backgroundColor: 'rgba(255, 0, 0, 0.1)', color: 'red'}} className={message}>
                    {message}
                </div>
            )}
            <h1 className='text-black text-center font-bold text-3xl'>Увійти до аккаунту</h1>
