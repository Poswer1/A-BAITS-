...
function page() {
  ...
  return (
    <div className='flex flex-col justify-center items-center h-screen w-full text-black'>
        <div className='flex flex-col justify-center items-center sm:w-2/5 xl:w-2/5 2xl:w-1/4 rounded-md p-5 gap-5'>
            {message && (
                <div style={{backgroundColor: 'rgba(255, 0, 0, 0.1)', color: 'red'}} className={message}>
                    {message}
                </div>
            )}
            <h1 className='text-black text-center font-bold md:text-2xl 2xl:text-3xl'>Увійти до аккаунту</h1>
