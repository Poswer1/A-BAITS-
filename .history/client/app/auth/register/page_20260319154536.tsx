...
function page() {
  ...
  return (
    <div className='flex flex-col justify-center items-center h-screen w-full text-black'>
        <div className='flex flex-col justify-center items-center w-full xl:w-[20%] rounded-md p-5 gap-5'>
            {message && (
                <div style={{backgroundColor: 'rgba(255, 0, 0, 0.1)', color: 'red'}} className={messageError}>
                    {message}
                </div>
            )}
            <h1 className='text-black text-center font-bold text-2xl md:text-2xl 2xl:text-3xl'>Реєстрація</h1>
