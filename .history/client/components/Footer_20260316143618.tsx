    ...
    <div className="flex justify-start items-start w-full bg-[#0F0F0F]">
      <div className="flex justify-start items-start w-[90%] gap-20">
        <div className={`${column} h-full p-10 relative`}>
           <Image src={'/images/Footer/logo.png'} alt="" width={100} height={100} className="w-[150px] h-auto"/>
            <span className="text-white 2xl:text-base ">© 2026  A-BAITS UKRAINE | All rights reserved</span>
        </div>
