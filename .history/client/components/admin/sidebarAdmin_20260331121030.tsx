...
import { User, Box, DollarSign, Bell, FileText, Settings, Gift, BarChart, ClipboardCheck} from 'lucide-react'
...
export default function SidebarAdmin() {
  ...
  const listLinks = [
    ...
    { name: t('admin', 'ControlOfViolations'), icon: <ClipboardCheck/>, link: '/ControlOfViolations' },
