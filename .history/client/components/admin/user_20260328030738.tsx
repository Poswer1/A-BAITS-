  ...
  return (
    <div className="flex flex-col w-full gap-2">
        ...
        {edit ? (
          ...
          <div className="flex flex-col justify-start items-start border-t border-b border-gray-300">
            {listUsers.map((user) => (
              <div className="flex justify-start items-center gap-4 bg-white w-full p-2">
