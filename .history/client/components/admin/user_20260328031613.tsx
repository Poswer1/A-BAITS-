  ...
  return (
    <div className="flex flex-col w-full gap-2">
        <div className='flex justify-start items-center gap-5 w-full'>
            ...
            <div className='flex items-center p-2 border border-gray-300 gap-2 rounded-xl w-1/3'>
              <Search className='text-gray-500' size={20}/>
              <input className='outline-none' value={searchValue} onChange={(e) => setSearchValue(e.target.value)} placeholder={t('admin', 'searchUser')}/>
            </div>
            {(message || error) && (
