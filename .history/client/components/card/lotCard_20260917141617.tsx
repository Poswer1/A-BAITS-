    ...
    return (
        <Link 
            ...
            <div className="flex flex-col justify-center items-center w-full md:w-full">
                ...
                <div className="flex flex-col justify-center items-start p-2 w-full bg-gray-100 rounded-b-xl">
                    <h1 className="line-clamp-1">{lot.name}</h1>
                    
                  
                    <span className="text-xl font-bold text-orange-600"><br />{lot.startPrice} ₴</span>
                   
                    <span className="text-black text-sm md:text-base">
                      {t('lot', 'lot-location')}: <span className="font-bold text-black"><br/>{city || lot.location}</span>
                    </span>
                    <div className="md:flex flex-col justify-center items-start gap-2 w-full hidden">
