  ...
  return (
    <Link
      ...
      className={`
        ...
        gap-10 shadow-lg text-black rounded-b-xl
        ${openFrom === 'catalog' ? 'w-full' : 'w-[200px]'}
        md:w-1/4
      `}
    >
      <div className="flex flex-col justify-center items-center w-full">
        ...
        <div
          className={`
            ...
            h-55 flex items-center justify-center overflow-hidden
          `}
        >
          <img
        ...
        <div className="flex flex-col justify-center items-start p-2 w-full bg-gray-100 gap-2 rounded-b-xl">
          ...
          {/* Местоположение — только ПК */}
          <span className="hidden md:block text-black text-sm md:text-base">
            {t('lot', 'lot-location')}:
            <br />
          ...
          <div className="flex justify-between items-center w-full">
            ...
            {/* ПК */}
            <div className="hidden md:flex flex-col justify-center items-start gap-2 w-full">
              ...
              <button
                ...
                className={`
                  ${hover}
                  p-2 bg-orange-600 rounded-md text-white
            ...
            {/* Мобильная версия */}
            <div className="flex md:hidden justify-end items-center gap-3 w-full">
