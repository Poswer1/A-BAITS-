...
export default function TransactionCard({ transaction, setTransactions }: TransactionCardProps) {
    ...
    return (
   <div key={transaction._id} className={`${transaction.type === 'Return' && 'opa'} flex justify-between items-center w-full bg-white border-t border-b border-gray-200 p-2 h-20`}>
