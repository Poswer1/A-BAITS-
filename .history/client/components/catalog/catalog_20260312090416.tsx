...
export default function Catalog({category, subCategory, subSubCategory, city, lots, totalLot}:CatalogProps) {
  return (
    <div className='flex flex-col justify-start items-start w-full mt-2 min-h-200'>
        ...
        <span className='text-gray-500 text-sm'>Найдено лотов: {tot}</span>
