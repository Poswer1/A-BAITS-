  ...
  return (
    <div className='flex flex-col md:p-2 justify-start items-start w-full  md:min-h-200 overflow-x-hidden p-2'>
          ...
          <div className="flex w-full overflow-x-auto items-center gap-2 ">
            {activeFilters.map(filter => (
                <button
                    ...
                    className="flex items-center gap-1 rounded-md bg-orange-600/10 py-1 text-sm text-orange-600 hover:bg-orange-600/20 shrink-0"
                >
                    {filter.label}
                    <X size={16}/>
                </button>
        ...
        <div className='flex flex-col justify-start items-start w-full mt-2'>
          <div className='flex justify-start items-center w-full text-black gap-1'>
            <LayoutGrid  />
            <Rows3 />
          </div>
