  ...
  return (
    <div className='flex flex-col md:p-2 justify-start items-start w-full  md:min-h-200 overflow-x-hidden p-2'>
        ...
        <div className='flex flex-col justify-start items-start w-full mt-2'>
          <div className="flex items-center gap-1 rounded-lg bg-gray-100 p-1 text-black"> <button className="flex h-9 w-9 items-center justify-center rounded-md bg-white shadow-sm transition hover:bg-gray-50" > <LayoutGrid size={18} strokeWidth={1.8} /> </button> <button className="flex h-9 w-9 items-center justify-center rounded-md text-gray-500 transition hover:bg-white hover:text-black" > <Rows3 size={18} strokeWidth={1.8} /> </button> </div>
