    ...
    <div className='flex flex-col md:p-2 justify-start items-start w-full  md:min-h-200 overflow-x-hidden p-2'>
        ...
        <div className='flex flex-col justify-start items-start w-full mt-2 gap-2'>
          <div className='flex justify-start items-center text-black gap-2'>
            <span onClick={() => setStateCard('Tile')} className={`${stateCard === 'Tile' && 'bg-orange-600/30'} flex justify-center items-center p-2 bg-gray-100 rounded-md`}>
              <LayoutGrid size={18}/>
            </span>
            <span onClick={() => setStateCard('Grid')} className={`${stateCard === 'Grid' && 'bg-orange-600/30'} flex justify-center items-center p-2 bg-gray-100 rounded-md`}>
              <Rows3 size={18}/>
            </span>
          </div>
