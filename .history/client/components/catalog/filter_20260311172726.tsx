...
export default function Filter() {
  ...
  const [sort, setSort] = useState(t('catalog', ''))
  ...
  return (
    <div className={`${open && 'w-90'} flex flex-col bg-white justify-start items-start h-full p-5 gap-4`}>
      ...
      <SelectionField title={t('catalog', 'sort')} placeholder={t('catalog', 'LowToUp')} list={listLowToUpPrice} value={city} setValue={setCity}/>
    </div>
  )
}
