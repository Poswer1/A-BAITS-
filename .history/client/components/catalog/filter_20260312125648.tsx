        ...
        <div className={`${open ? 'opacity-100 duration-1000' : 'opacity-0 duration-100'}`}>
          ...
          <div className="flex flex-col justify-center items-center w-full gap-1">
            <div className="flex justify-center items-center gap-2 w-full">
              <InputField label={t('catalog', 'from')} type="number" onChange={setMinPrice} value={minPrice} maxTotal={maxPriceLot.toString()} minTotal='0'/>
              <InputField label={t('catalog', 'to')} type="number" onChange={setMaxPrice} value={maxPrice} minTotal={maxPriceLot.toString()} maxTotal={maxPriceLot.toString()}/>
            </div>
            <input 
            type="range"  
            min="0" 
