...
export default function Filter({maxPriceLot}: FilterProps) {
  ...
  return (
    <div className={`${open ? 'w-full top-0 fixed md:static md:w-100 p-0' : 'w-0 md:w-20 p-5'} transition-all duration-300 ease-in-out flex flex-col bg-white justify-start items-start h-screen gap-4 border-r border-gray-300`}>
