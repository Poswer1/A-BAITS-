...
export default function Filter({maxPriceLot}: FilterProps) {
  ...
  return (
    <>
      ...
      <Sliders className='text-orange-600 cursor-pointer' size={35} onClick={() => setOpenMobile(true)}/>
    
    <div className={`${isOpen ? 'w-full top-0 fixed md:static md:w-100 p-5 ' : 'w-0 md:w-20 p-0'} md:p-5 transition-all duration-300 ease-in-out flex flex-col bg-white justify-start items-start h-screen gap-4 border-r border-gray-300 text-black`}>
