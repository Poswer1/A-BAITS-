...
export default function Filter({maxPriceLot}: FilterProps) {
  ...
  return (
    <>
    <div className="bg-orange-600 p-2 text-white fixed top-1/2 z-10 md:hidden" onClick={() => setOpenMobile(true)}>
      <Sliders className='text-orange-600 cursor-pointer' size={35}/>
    </div>
