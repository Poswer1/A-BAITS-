...
export default function Filter({maxPriceLot}: FilterProps) {
  ...
  const listLowToUpPrice = [
    ...
    {name: 'newFirst', ru:'Меньше времени до конца аукциона', uk: 'Менше часу до кінця аукціону'},
    {name: 'oldFirst', ru:'Больше времени до конца аукциона', uk: 'Більше часу до кінця аукціону'},
