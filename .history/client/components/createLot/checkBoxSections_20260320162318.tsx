  ...
  return (
    <div className={block}>
        <div className={Blockinput}>
            ...
            <p className='text-gray-500'>{mode === 'autoReExtension' ? t('createLot','create-autoReExtension-descriptions') : t('createLot','create-advertising-descriptions')} <span className="font-bold text-orange-600">{t('global','PaidFeature')}</span></p>
