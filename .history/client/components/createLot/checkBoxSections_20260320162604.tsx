  ...
  return (
    <div className={block}>
        <div className={Blockinput}>
            ...
            <p className='text-gray-500 text-sm mt-2'>{mode === 'autoReExtension' ? t('createLot','create-autoReExtension-descriptions') : t('createLot','create-advertising-descriptions')}</p>
