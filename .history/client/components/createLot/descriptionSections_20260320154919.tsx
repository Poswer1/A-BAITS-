...
export default function DescriptionSections({description, setDescription}:DescriptionSectionsProps) {
  ...
  return (
    <div className={block}>
      <InputField label={t('createLot','createLot-descriptions')} value={description} placeholder={t('createLot','createLot-descriptions')} onChange={setDescription} textarea={true} hTextArea='70'/>
