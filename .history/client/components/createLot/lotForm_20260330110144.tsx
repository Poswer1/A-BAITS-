...
export default function LotForm({mode, initialData}:LotFormProps) {
    ...
    const handleCreateOrUpdate = async () => {
       if (!name || !description || !stateLot || !location || !delivery || !price || !priceStep || date !== 0 || !time || !category || !preview || preview.length === 0) {
      ...
      if(description.length > 1200) {
        ...
        if(mode === 'edit') {
          preview.forEach(p => formData.append('preview', p))
        }
