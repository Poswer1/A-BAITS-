...
export default function MainInfoSections({name, setName, openCategory, setOpenCategory, category, subCategory, subSubCategory} : MainInfoProps) {
  ...
  return (
    <div className={block}>
        <InputField label={t('createLot','createLot-name')} value={name} onChange={setName} placeholder={t('createLot','createLot-nameInput')} type="text" maxLength={70} minLengthText=''/>
