    ...
    <div className={`${block} gap-4`}>
        <div className={Blockinput}>
         ...
         <div className={Blockinput}>
            ...
            <div onClick={() => setOpenCategory(prev => !prev)} className={` ${hover} flex justify-between items-center w-full md:w-1/2 bg-gray-100 text-black p-2 rounded-md ${() && 'bg-orange-600/10'}`}>
