  ...
  return (
    <div className={block}>
       <div className={Blockinput}>
          ...
          <div className="flex  touch-pan-x overflow-x-auto md:flex-wrap justify-start items-center w-full gap-3"></div>
          <div className="flex  touch-pan-x overflow-x-auto md:flex-wrap justify-start items-center w-full gap-3"> 
