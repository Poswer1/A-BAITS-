  ...
  return (
    <div className={block}>
       <div className={Blockinput}>
          ...
          <label className=label htmlFor="fileInput" key={index} className="flex justify-center items-center bg-gray-100 h-32 w-[48%] md:w-1/5 cursor-pointer relative overflow-hidden">
