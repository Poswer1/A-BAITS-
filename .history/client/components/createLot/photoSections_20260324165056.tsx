  ...
  return (
    <div className={block}>
       <div className={Blockinput}>
          ...
          <label htmlFor="fileInput" className={`${file.length > 0 && 'hidden'} md:hidden border-dashed flex flex-col gap-2 justify-center items-center h-50 bg-orange-600/10 w-full rounded-lg`}>
