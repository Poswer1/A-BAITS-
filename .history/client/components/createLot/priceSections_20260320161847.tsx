    ...
    <div className={`${block} gap-5`}>
        <div className={`${block} flex-row !justify-start gap-10 !p-0`}>
          <div className={`${Blockinput} !w-1/4`}>
            <InputField 
            type="number" value={price} onChange={setPrice} label={`${t('createLot','createLot-StartingPrice')} ₴`} placeholder={t('createLot','createLot-StartingPrice')}/>
          </div>
          <div className={`${Blockinput} !w-1/4`}>
        ...
        <div className={`${block} flex-row !justify-start gap-10 !p-0`}>
          <div className={`${Blockinput} !w-1/4`}>
            <InputField type="number" value={blitzPrice} onChange={setBlitzPrice} label={`${t('createLot','createLot-Blitz')} ₴ (${t('global','NotNecessary')})`} placeholder={t('createLot','createLot-Blitz-descriptions')}/>
          </div>
        </div>
      </div>
  )
