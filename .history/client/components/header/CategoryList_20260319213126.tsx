...
const nameLang = (item: { ru?: string; uk?: string; name: string }) =>
  ...
  return (
    ...
    <div className={`${overlay}`} onClick={() => setOpenCategory(false)}>
          ...
          <div className="flex justify-between items-center w-full text-black border-b p-2 md:hidden">
                <h1 className="text-black text-xl font-bold">{nameLang(category) || 'Категория'}</h1>
                <X />
            </div>
