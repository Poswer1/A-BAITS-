  ...
  return (
    ...
    <div className={`${overlay}`} onClick={() => setOpenCategory(false)}>
          ...
          <div className="flex justify-between items-center w-full text-black border-b border-gray-300 p-2 md:hidden bg-white">
            ...
            <ul className={`${open ? ""} ${activeCategory && 'hidden md:flex'} flex flex-col justify-start items-start gap-3 md:border-r p-2 w-full md:w-auto overflow-auto h-screen md:h-auto`}>
