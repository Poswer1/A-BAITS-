        ...
        <div className='flex flex-col justify-center items-center w-[90%] p-2 relative'>
            <div className='flex justify-between items-center w-full p-2'>
                ...
                <div className={`md:flex justify-center items-center gap-3 w-full`}>
                    <button onClick={() => setOpenCategory(prev => !prev)} className={`font-medium hidden md:block flex justify-center items-center gap-1 ${hover} bg-orange-600 text-white p-2 px-4 rounded-md`}><Menu size={20}/>{t('header','category')}</button>
