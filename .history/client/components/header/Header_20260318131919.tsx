        ...
        <div className='flex flex-col justify-center items-center w-[90%] p-2 relative'>
            <div className='flex justify-between items-center w-full p-2'>
                ...
                <div className={`flex justify-center items-center gap-3 w-full`}>
                    ...
                    <div className={`flex flex-col justify-center items-center lg:w-[60%] 2xl:w-[40%] relative ${openSearch ? 'block' : 'hidden md:block'}`}>
                ...
                <div className='flex justify-center items-center gap-5 whitespace-nowrap relative'>
                        ...
                        <Bell className={`${hoverSub} ${openSearch ? 'hidden md:block' : ''} ${read ? 'text-orange-600': 'text-gray-500'}`} onClick={() => setOpenNotification(prev => !prev)}/>
