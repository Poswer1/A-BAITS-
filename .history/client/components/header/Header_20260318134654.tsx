            ...
            <div className='flex justify-between items-center w-full p-2'>
                <Link href={`/${lang}`}>
                    <Image 
                        ...
                        width={200}
                        height={200}
                        className={` w-[200px] md:w-[150px] h-auto ${openSearch ? 'hidden md:block' : 'block'}`}
                    />
                </Link>
                <div className='flex justify-center items-center gap-3 w-full'>
                    ...
                    <div className={`md:flex flex-col justify-center items-center ${openSearch ? 'block' : 'hidden'} md:block w-full md:w-[60%] 2xl:w-[40%] relative`}>
