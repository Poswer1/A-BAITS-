        ...
        <div className='flex flex-col justify-center items-center w-[90%] p-2 relative'>
            <div className='flex justify-between items-center w-full p-2'>
                ...
                <div className='flex justify-center items-center gap-3 w-full'>
                    ...
                    <div className={`md:flex flex-col justify-center items-center ${openSearch ? 'block w-100' : 'w-0 !p-0'} transition-all duration-300 md:block md:w-[60%] 2xl:w-[40%] relative`}>
