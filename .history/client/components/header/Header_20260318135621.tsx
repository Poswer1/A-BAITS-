            ...
            <div className='flex justify-between items-center w-full p-2'>
                ...
                <div className='flex justify-center items-center gap-3 w-full'>
                    ...
                    <div className={`flex flex-col justify-center items-center ${openSearch ? 'block w-full' : 'w-0'} transition-all duration-500 md:block md:w-[60%] 2xl:w-[40%] relative`}>
                        <div className={`flex justify-start items-center p-2 gap-2 bg-gray-100 rounded-md border border-gray-200 w-full z-90 ${openSearch ? 'block' : 'hidden md:block md:flex'}`}>
