...
function Header() {
  ...
  return (
    <div className='flex flex-col justify-center items-center w-full z-20'>
        <div className='flex flex-col justify-center items-center md:w-[90%] p-2 relative'>
            <div className='flex justify-between items-center w-full p-2'>
                ...
                <div className='flex justify-center items-center gap-3 w-full'>
                    ...
                    <SearchSection openSearch={openSearch} setOpenSearch={setOpenSearch} lang={lang}/>
                </div>
                <div className='flex justify-center items-center gap-5 whitespace-nowrap relative'>
                        ...
                        <ChangeLanguage />
                            ...
                            <Search className={`${openSearch ? 'hidden' : 'block'} text-gray-500 md:hidden`} onClick={() => setOpenSearch(true)}/>
