        ...
        <div className='flex flex-col justify-center items-center w-full md:w-[90%] p-2 relative'>
            <div className='flex justify-between items-center w-full p-2'>
                ...
                <div className='flex justify-center items-center gap-5 whitespace-nowrap relative'>
                        <span className={`p-1 bg-orange-600 md:hidden rounded-md ${openSearch ? 'hidden md:block' : ''}`}>
                        ...
                        <Bell className={`${hoverSub} ${openSearch ? 'hidden md:block' : 'hidden md:block'} ${read ? 'text-orange-600': 'text-gray-500'}`} onClick={() => setOpenNotification(prev => !prev)}/>
