        ...
        <div className='flex flex-col justify-center items-start w-full md:w-[90%] p-2 relative'>
            <div className='flex justify-between items-center w-full p-2'>
                ...
                <div className='flex justify-center items-center gap-5 whitespace-nowrap relative'>
                        ...
                        {!auth ? (
                            <Link href={`/${auth}/auth/login`} className={`p-2 px-4 rounded-md ${hover} bg-orange-600 text-white flex gap-1 justify-center items-center`}><LogIn size={20}/>{t('header','login')}</Link>
                        ): (
                            <>
