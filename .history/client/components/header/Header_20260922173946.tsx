            ...
            <div className='flex justify-between items-center w-full p-2'>
                ...
                <div className='flex justify-center items-center gap-5 whitespace-nowrap relative'>
                        ...
                        {!auth ? (
                            ...
                            <Link href={`/${lang}/auth/login`} className={`p-1 px-4 rounded-md ${hover} ${openSearch ? "hidden md:block" : "block"} bg-orange-600 text-white flex gap-1 justify-center items-center`}>
                                <LogIn size={20}/>
                            </Link>
                            </>
                        ): (
