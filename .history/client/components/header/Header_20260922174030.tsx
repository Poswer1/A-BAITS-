    ...
    <div className='flex flex-col justify-center items-center w-full z-20'>
        <div className='flex flex-col justify-center items-start w-full md:w-[90%] p-2 relative'>
            <div className='flex justify-between items-center w-full p-2'>
                ...
                <div className='flex justify-center items-center gap-4 whitespace-nowrap relative'>
                        ...
                        {!auth ? (
                            ...
                            <Link href={`/${lang}/auth/login`} className={`p-1  rounded-md ${hover} ${openSearch ? "hidden md:block" : "block"} bg-orange-600 text-white flex gap-1 justify-center items-center`}>
                                <LogIn />
                            </Link>
                            </>
                        ): (
