...
function OpenProfile({setOpenProfile, name}: OpenProfile) {
  ...
  return ( 
    <div ref={modalRef} className={` ${animationOpacity} flex flex-col justify-center items-center bg-white rounded-xl absolute right-[-15] top-10 text-black z-20 w-40`}>
