...
function OpenProfile({setOpenProfile, name, open}: OpenProfile) {
  ...
  return ( 
    <div ref={modalRef} className={`${open ? "opacity-100 h-100 pointer-events-auto" : "opacity-0 h-0 pointer-events-none"} ${animate} flex flex-col justify-center items-center bg-white rounded-xl absolute right-[-10] md:right-0 top-10 text-black z-20 w-40`}>
