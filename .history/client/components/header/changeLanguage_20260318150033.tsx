...
export default function ChangeLanguage() {
  ...
  return (
    <div onClick={() => setOpen(prev => !prev)}className='flex justify-center items-center gap-1 md:gap-2 cursor-pointer relative'>
        ...
        {open && (
          <div ref={modalRef} onClick={(e) => e.stopPropagation()} className='  md:w-full p-2 absolute left-0 top-[100%] flex flex-col justify-center items-start z-10 bg-white text-black rounded-xl gap-2'>
