...
export default function OpenNotification() {
    ...
    const mo = useClickOutside

  return (
    <div ref={ref} className='flex flex-col justify-start items-start bg-gray-100 p-2 w-100 absolute top-[100%] left-0 rounded-md gap-2 z-30'>
        {loading ? (
