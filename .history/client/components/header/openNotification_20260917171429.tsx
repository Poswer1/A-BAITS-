...
export default function OpenNotification({setOpen, open, setRead}: OpenNotification) {
  ...
  return (
    <div ref={modalRef} className={`transition-all duration-500 ${open ? 'md:h-2/3' : 'h-0'} flex flex-col w-full md:w-150 justify-start overflow-hidden items-start custom-scrollbar bg-white fixed top-[9%] md:top-[10%] 2xl:top-[7%] right-0 md:right-10 gap-2 z-30 text-black shadow-xl md:rounded-xl`}>
        {loading ? (
