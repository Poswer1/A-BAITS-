...
export default function BidHistory({userHistory}:BidHistoryProps) {
  ...
  return (
    <div className={`${columnBlock} w-full md:w-auto`}>
      <h1 className="font-bold">{t('lot', 'lot-historyBid')}</h1>
      <div className="flex flex-col justify-start items-start overflow-auto max-h-50 md:max-h-full gap-5 custom-scrollbar">
