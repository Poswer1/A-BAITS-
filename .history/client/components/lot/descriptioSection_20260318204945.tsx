...
export default function DescriptioSection({lot}: {lot:LotTypes}) {
  ...
  return (
    <div className={`${columnBlock}`}>
        <div className='flex flex-col justify-start items-start gap-2 max-h-auto md:max-h-[230px]'>
            ...
            <div className={`overflow-auto custom-scrollbar ${open ? 'h-auto opacity-100' : 'h-0 opacity-0'} transition-all duration-500`}>
