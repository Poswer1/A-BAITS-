...
export default function DescriptioSection({lot}: {lot:LotTypes}) {
  ...
  return (
    <div className={`${columnBlock}`}>
        <div className='flex flex-col justify-start items-start gap-2 max-h-[230px] relative'>
            ...
            <div className='flex justify-center items-center bg-orange-600 rounded-full absolute top-1/2 right-0 md:hidden'>
