...
export default function HeaderLot({lot}:HeaderLot) {
  ...
  return (
    <div className='w-full justify-center items-center sticky top-0 z-15 flex  border-b border-gray-300 text-black'>
        <div className='w-full 2xl:w-[80%] lg:w-[90%] bg-white p-2 flex justify-between items-end'>
            ...
            <div className="flex md:flex-col justify-center md:items-end gap-2">
                <span className="md:hidden flex font-bold"><ChevronLeft />Назад</span>
