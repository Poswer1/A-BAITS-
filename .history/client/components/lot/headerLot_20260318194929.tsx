...
export default function HeaderLot({lot}:HeaderLot) {
    ...
    const transleteSubCategory = getValueByLang(listCategory?.subcategories, lot.subCategory, lang)
    const transleteSubSubCategory = getValueByLang([listCategory], lot.subSubCategory, lang)
