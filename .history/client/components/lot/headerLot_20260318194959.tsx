...
export default function HeaderLot({lot}:HeaderLot) {
    ...
    const transleteSubCategory = getValueByLang([listSubCategory], lot.subCategory, lang)
    const transleteSubSubCategory = getValueByLang(listSubCategory?.subcategories, lot.subSubCategory, lang)
