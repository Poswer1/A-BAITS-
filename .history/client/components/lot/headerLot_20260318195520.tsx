        ...
        <div className='w-full 2xl:w-[80%] lg:w-[90%] bg-white p-2 flex justify-between items-end'>
            <div className='flex flex-col justify-center items-start gap-2 hidden md:block'>
                ...
                <div className="flex justify-start items-center gap-6 text-gray-800">
                    ...
                    <span className="flex text-black">{TransleteCategory && lang === 'ru' ? TransleteCategory.ru : listCategory?.uk} | {listSubCategory && lang === 'ru' ? listSubCategory.ru : listSubCategory?.uk} | {listSubCategory?.subcategories && lang === 'ru' ? listSubCategory?.subcategories.ru : listSubCategory?.subcategories?.uk}</span>
                </div>
            </div>
