...
interface HeaderLot {
    lot:any
    transleteState:string,
    transleteCity:string,
    TransleteCategory:string[],
    TransleteSubCategory:string[],
    TransleteSubSubCategory:string[]
}

export default function HeaderLot({lot, transleteCity,transleteState,TransleteCategory,TransleteSubCategory,TransleteSubSubCategory}:HeaderLot) {
  ...
  return (
    <div className='w-full justify-center items-center sticky top-0 z-15 md:flex border-b border-gray-300 text-black '>
        <div className='w-full flex-col md:flex-row 2xl:w-[80%] lg:w-[90%] bg-white p-2 flex justify-between items-end'>
            <div className='flex flex-col justify-center items-start gap-2'>
                <h1 className="text-2xl font-bold">{lot.name || 'Not Found'}</h1>
                <div className="flex flex-wrap text-sm md:text-base justify-start items-center md:gap-6 text-gray-800">
