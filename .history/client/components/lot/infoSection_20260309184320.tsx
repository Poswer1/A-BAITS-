    ...
    <div className={`${columnBlock} w-full`}>
        ...
        {status === 'Active' && (
            <>
                ...
                <button onMouseDown={handleBuyNow} onMouseLeave={handleLeaveBuyNow} onMouseUp={han} className={`w-full ${hover} text-black border-orange-600 border !text-orange-600 rounded-md p-2 text-lg`}>
