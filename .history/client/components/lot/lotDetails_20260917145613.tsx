...
export default function LotDetails({ lot }: LotDetailsProps) {
  ...
  return (
    <div className="flex flex-col justify-start items-center w-full relative min-h-screen md:h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-start items-start 2xl:w-[80%] lg:w-[90%] py-2 md:gap-2 w-full md:min-h-200 md:h-200">
        <PhotoSection lot={lot} />
        <div className="flex flex-col justify-start items-start w-full md:w-auto pb-36 md:pb-0">
