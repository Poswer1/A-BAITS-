      ...
      {confirmCreateOrder ? (
       <Success title={t('createLot', 'lotSuccess')}/>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center w-[90%] mt-5 md:mt-10 gap-5 md:gap-0">
          <h1 className="text-orange-600 text-3xl font-bold gap-2">{mode === 'create' ? t('createLot','createLot-title') : t('createLot','createLot-title')} <span className="text-black">лоту</span></h1>
