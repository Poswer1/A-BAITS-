...
export default function LotCardV2({lot, show}: LotCardV2Props) {
  ...
  return (
    <Link href={`/${lang}/lot/${lot.lotNumber}`} className={`cursor-pointer flex flex-col md:flex-row justify-start items-start md:items-center gap-10 shadow-lg bg-white w-full rounded-md text-base`}>
