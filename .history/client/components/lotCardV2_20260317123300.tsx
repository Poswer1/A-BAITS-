...
export default function LotCardV2({lot, show}: LotCardV2Props) {
  ...
  return (
    <Link href={`/${lang}/lot/${lot.lotNumber}`} className={`cursor-pointer p-2 md:p-0 flex flex-col md:flex-row justify-start items-start md:items-center  gap-2 md:gap-10 shadow-lg bg-white w-full rounded-md text-base`}>
        <div className={`${columnClass} md:hidden`}>
        ...
        <img src={`${BASE_URL}${lot.images[0]}`} className="rounded-l-md object-cover w-30 md:w-40"/>
