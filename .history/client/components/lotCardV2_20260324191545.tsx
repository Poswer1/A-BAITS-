...
export default function LotCardV2({lot, show}: LotCardV2Props) {
  ...
  return (
    <Link href={`/${lang}/lot/${lot.lotNumber}`} className={`cursor-pointer border-t border-b border-gray-500 flex flex-col md:flex-row justify-start items-start md:items-center gap-2 md:gap-10 shadow-lg bg-white w-full  md:rounded-md text-base text-black`}>
        ...
        <div className="flex justify-start items-center gap-2 md:hidden bg-gray-100">
            <img src={`${BASE_URL}${lot.images[0]}`} className="md: object-cover w-30 md:w-40"/>
