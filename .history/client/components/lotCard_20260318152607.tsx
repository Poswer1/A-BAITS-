...
function LotCard({lot}: LotCardProps) {
    ...
    return (
        <Link href={`/${lang}/lot/${lot.lotNumber}`} className={`cursor-pointer flex justify-start items-center gap-10 shadow-lg text-black w-full`}>
            <div className="flex flex-col justify-center items-center w-full md:w-65 2xl:w-95">
