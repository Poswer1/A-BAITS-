...
export default function Balance({allTransaction}: BalanceProps) {
  ...
  return (
     <div className={`flex flex-col w-full gap-5` }>
      <div className='flex flex-col md:flex-row p-3 bg-white rounded-lg justify-between items-center w-full'>
        <h1 className='text-gray-500 text-center md:text-start text-xl'>{t('profile', 'CurrentBalance')}: <br/><span className='text-black text-2xl'>50 ₴</span></h1>
