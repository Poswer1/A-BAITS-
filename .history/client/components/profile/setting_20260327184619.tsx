...
export default function Setting({id, user}: SettingProps) {
                ...
                <div className="flex flex-col justify-start items-start w-full 2xl:w-4/5 gap-5">
                  ...
                  <div className={blockClass}>
                        ...
                        <div className="flex flex-col justify-center items-start">
                          <h1 className="text-xl hidden md:block">{user?.name}</h1>
                          <span className="text-gray-500 text-sm hidden md:block">{user?.location || t('profile', 'cityNotSelected')}</span>
