    ...
    >
      {listLinks.map(link => (
            <Link
              ...
              className={`${hoverCat} px-5 lg:px-7 2xl:px-10 py-4 border-r-2 border-transparent flex justify-start items-center w-full gap-2 ${pa === link.name && linkActiveClass}`}
            >
