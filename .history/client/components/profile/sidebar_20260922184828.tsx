...
export default function Sidebar({mode, active, name} : SidebarProps) {
  ...
  return (
    <div 
      className={` relative z-30 bg-white text-black w-screen md:w-auto md:overflow-x-hidden overflow-x-auto flex ${mode === 'sidebarMain' && 'md:flex-col md:min-h-[92vh]'} 
    ...
    >
      <div className={`${mode === 'sidebarMain' ? 'flex md:flex-col' : 'flex'} relative z-30 w-max min-w-full`}>
        {listLinks.map(link => {
