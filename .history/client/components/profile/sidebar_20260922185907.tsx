      ...
      <div className={`${mode === 'sidebarMain' ? 'flex md:flex-col' : 'flex'} w-max min-w-full`}>
        ...
        return (
          <Link
              ...
              href={href}
              className={`${hoverCat} p-4 lg:px-7 2xl:px-10 border-r-2 border-transparent flex whitespace-nowrap justify-start items-center w-40 shrink-0 ${mode === 'sidebarMain' ? 'md:w-full' : 'md:w-auto'} gap-2 ${active === link.name && linkActiveClass}`}
            >
