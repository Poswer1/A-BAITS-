...
const BASE_URL = process.env.NEXT_PUBLIC_URL
 ...
 return (
    <>
        <div className={`bg-gray-300 rounded-3xl flex justify-center items-center overflow-hidden cursor-pointer relative`} style={{width: `${size || '45'}px`, height: `${size || '45'}px`}} >
