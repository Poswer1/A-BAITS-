...
export default function InputField({
  ...
  return (
    <div className={`flex flex-col justify-start items-start w-full`}>
      ...
      <div className={`flex justify-start items-center w-full bg-gray-100 ${maxLength && stringValue.length > maxLength ? 'border-orange-600 bg-orange-600/10' : 'border-gray-300'} rounded-md border`}>
        {textarea ? (
          <textarea
