    ...
    <div className={`flex flex-col justify-start items-start w-full`}>
      ...
      {maxLength && (
        <div className={`flex justify-between items-center w-full`}>
          <span className={`text-gray-500 text-sm ${stringValue.length > maxLength && 'text-red-600'}`}>{maxLength === 70 ? t('createLot', 'createLot-lengthName') : t'createLot-lengthdescriptions'}</span>
