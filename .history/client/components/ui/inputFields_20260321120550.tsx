...
export default function InputField({
  ...
  return (
    <div className={`flex flex-col justify-start items-start w-full`}>
      ...
      <div className={`flex justify-start items-center w-full border border-gray-300 ${maxLength && stringValue.length > maxLength ? 'border-red-600 bg-red-600/10' : ''} rounded-xl `}>
        {textarea ? (
          <textarea
