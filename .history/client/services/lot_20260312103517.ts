...
export async function getFilterLot(category?:string, subCategory?:string, subSubCategory?:string, city?:string, minPrice?:string, maxPrice?:string, state?:string[], sort?:string) {
    ...
    if(state ! == undefined)params.set('sort', sort.to)
