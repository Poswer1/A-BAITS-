...
export async function getFilterLot(category?:string, subCategory?:string, subSubCategory?:string, city?:string, minPrice?:string, maxPrice?:string, state?:string[], sort?:string, search?:string) {
    ...
    if(search !== undefined)params.set('search', )
