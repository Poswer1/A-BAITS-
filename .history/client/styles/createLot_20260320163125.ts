export const Blockinput = 'flex flex-col justify-center items-start md:w-full 2xl:w-3/5 gap-1'
export const nameInput = 'text-black text-sm'
export const input = 'p-2 flex justify-start items-center outline-none rounded-md border-gray-100 w-full'
export const block = 'flex flex-col justify-center items-start w-full bg-white p-5 rounded-xl relative'
