...
export const nameInput = 'text-black md:text-sm'
export const input = 'p-2 flex justify-start items-center outline-none rounded-md border-gray-100 w-full'
export const block = 'flex flex-col justify-center items-start w-full bg-white p-5 rounded-xl relative text-black'
