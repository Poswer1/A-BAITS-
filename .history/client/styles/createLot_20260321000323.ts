...
export const block = 'flex flex-col justify-center items-start w-full bg-white p-5 border border-gray-100 00 md:border-none md:rounded-xl relative text-black'
