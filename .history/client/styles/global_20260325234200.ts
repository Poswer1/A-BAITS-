...
export const messageError = 'flex justify-center items-center p-2 border border-red-600 text-red-600 bg-red-500/20 text-center rounded-xl text-center fixed bottom-10 left-1/2'
