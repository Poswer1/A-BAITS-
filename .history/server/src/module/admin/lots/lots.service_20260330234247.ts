...
export class LotsService {
    ...
    async getAllTurnover() {
        ...
        return {
            day: {total: turnover?.day[0].total, createdAt: turnover?.day[0]?.createdAt},
            week: {total: turnover?.week[0]?.total, createdAt: turnover?.week[0]?.createdAt},
            month: {total: turnover?.month[0]?.total, createdAt: turnover?.month[0]?.createdAt}
        }
    }
}