...
export class ChatGateway {
    ...
    async newReview(data: {to:string, newMessage:{from:string, to:string, message:string, read:boolean, createdAt:string}}) {
        this.server.to(data.to).emit('newReview', data.newMessage)
    }
