...
export class ChatGateway {
    ...
    async newReview(to:string, newMessage:from:Schema.Types.ObjectId, to:Schema.Types.ObjectId, message:string, read:boolean, createdAt:Date, _id:Schema.Types.ObjectId) {
