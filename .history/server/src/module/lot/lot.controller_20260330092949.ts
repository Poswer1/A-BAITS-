...
import { RequestInterface } from 'src/types/request.interface';
...
export class LotController {
  ...
  @Patch('updateLot/:id')
  @UseInterceptors(FilesInterceptor('images', 8, ImagesInterceptor('./uploads/lots')))
  async updateLot(@Req() req: Request, @Body() dto: LotDto, @Param('id') id:string,  @UploadedFiles() files: Express.Multer.File[], @CurrentUser('id') userId:string) {
