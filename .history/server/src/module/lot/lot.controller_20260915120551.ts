...
export class LotController {
  ...
  @UseGuards(JwtAuthGuard)
  @Patch('closeLot/:id')
    async closeLot(@Param('id') id:string, @CurrentUser('role') role:string) {
    return this.lotService.closeLot(id, role)
  }
  ...
  @UseGuards(JwtAuthGuard)
  @Patch('resumeLot/:id')
  async resumeLot(@Param('id') id:string, @CurrentUser('id') userId:string, @CurrentUser('role') role:string) {
    return this.lotService.resumeLot(id, userId, role)
  }
