...
export class LotService {
  async createLot(dto: LotDto, files: Express.Multer.File[], userId:string) {
    ...
    let summaryPrice = 0
    dto.Advertising = dto.Advertising === true || dto.Advertising === 'true';
dto.autoReExtension = dto.autoReExtension === true || dto.autoReExtension === 'true';
    if(dto.Advertising === true ) {
      summaryPrice += 20
    }
    if(dto.autoReExtension === true) {
      summaryPrice += 20
    }
