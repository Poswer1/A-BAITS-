...
function OpenProfile({setOpenProfile, name}: OpenProfile) {
  ...
  return ( 
    <div ref={modalRef} className={` ${animationOpacity} flex flex-col justify-center items-center bg-white rounded-xl absolute right-[-10] md:right-0 top-10 text-black z-20 w-40`}>
