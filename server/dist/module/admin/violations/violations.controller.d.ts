...
export declare class ViolationsController {
    ...
    getAllViolations(page?: number, sort?: string, order?: string): Promise<{
        violations: (import("mongoose").Document<unknown, {}, import("../../../models/violations").Violations, {}, import("mongoose").DefaultSchemaOptions> & import("../../../models/violations").Violations & {
