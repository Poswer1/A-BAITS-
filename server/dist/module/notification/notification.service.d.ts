...
export declare class NotificationService {
    ...
    createNotification(to: string, notification: string, lotId: string): Promise<(import("mongoose").Document<unknown, {}, import("src/models/notification.model").NotificationType, {}, import("mongoose").DefaultSchemaOptions> & import("src/models/notification.model").NotificationType & {
        _id: Types.ObjectId;
    } & {
        __v: number;
    } & {
